...
# RCreator - Minecraft Mod Maker

<img align="right" width="300" src="https://mcreator.net/image/about/about1.png">

{Soon} - RCreator is a software used to make Minecraft Java Edition mods, Minecraft Bedrock Edition Add-Ons, and data packs using an intuitive easy-to-learn interface or with an integrated code editor.
forked from MCreator, all updates and things that might help the MCreator project will be pushed back to there project. 
...
This repository page is for people looking to contribute to RCreator. Visit {Soon} to download RCreator distribution and to engage in the community. Check {Soon} to find the support, forums, knowledge base, and more.

Download RCreator binary distributions on {Soon}.

## Contributing

You are welcome to support this project by opening pull requests. Read more about contributing in MCreators [contributing guidelines](CONTRIBUTING.md).
Before they can use your code, you must sign the [MCreator CLA](https://cla-assistant.io/MCreator/MCreator).
...
# MCreator, what RCreator is a fork of
